    ...
    <div className="bg-gray-50 text-gray-800">
      ...
      <section className="relative text-center py-28 bg-gradient-to-r from-blue-50 to-indigo-50">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <h2 className="text-5xl font-bold mb-6 text-blue-800">Welcome to the HSTU Research Portal</h2>
          <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto">Submit and manage your research papers with ease. Join our community of academic excellence.</p>
          <div className="flex justify-center space-x-4">
            <Link to="/submit" className="bg-blue-600 text-white py-3 px-8 rounded-md hover:bg-blue-700 transition shadow-lg flex items-center">
              <i className="fas fa-paper-plane mr-2"></i> Submit Your Research Info
            </Link>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="feature-card bg-white p-8 rounded-lg shadow-md transition duration-300">
              ...
              <h3 className="text-xl font-semibold mb-4 text-center">Submit Research Info</h3>
              <p className="text-gray-600 text-center">Upload your research papers info and manuscripts through our streamlined submission process.</p>
            </div>
            <div className="feature-card bg-white p-8 rounded-lg shadow-md transition duration-300">
              <div className="bg-blue-100 text-blue-600 rounded-full w-16 h-16 flex items-center justify-center mb-6 mx-auto">
                <i className="fas fa-search text-2xl"></i>
              </div>
              <h3 className="text-xl font-semibold mb-4 text-center">Verify</h3>
              <p className="text-gray-600 text-center">Verify your identification and research paper info</p>
            </div>
            <div className="feature-card bg-white p-8 rounded-lg shadow-md transition duration-300">
              <div className="bg-blue-100 text-blue-600 rounded-full w-16 h-16 flex items-center justify-center mb-6 mx-auto">
                <i className="fas fa-book-open text-2xl"></i>
              </div>
              <h3 className="text-xl font-semibold mb-4 text-center"> Share</h3>
              <p className="text-gray-600 text-center">Publish and unpublished research info will be shared</p>
            </div>
          </div>
        </div>
      </section>
